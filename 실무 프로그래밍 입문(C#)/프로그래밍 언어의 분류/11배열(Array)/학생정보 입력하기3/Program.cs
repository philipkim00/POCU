...
namespace 학생정보_입력하기3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("1    {0,-20}{1,-20}    {2,5}%", names[0], studentNumbers[0], grades[0]);
            Console.WriteLine("2    {0,-20}{1,-20}    {2,5}%", names[1], studentNumbers[1], grades[1]);
            Console.WriteLine("3    {0,-20}{1,-20}    {2,5}%", names[2], studentNumbers[2], grades[2]);
        }
    }
}
